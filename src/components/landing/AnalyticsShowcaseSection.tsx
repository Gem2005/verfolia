        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16 items-center">
          <div className="order-1 lg:order-2 space-y-5 sm:space-y-6 md:space-y-8 animate-slide-in-right">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-1 sm:pt-2">
              <Button 
                variant="outline" 
                size="lg"
                className="px-5 sm:px-6 md:px-8 py-4 sm:py-5 md:py-6 h-auto glass-card border-2 hover:border-blue-500/50 hover:bg-blue-500/5 hover:scale-105 transition-all duration-300 w-full sm:w-auto"
          ...
          <div className="order-2 lg:order-1 animate-slide-in-left">
            <div className="relative group">
              {/* Main Analytics Card */}
              <div className="glass-card-strong p-5 sm:p-6 md:p-8 lg:p-10 rounded-2xl sm:rounded-3xl shadow-2xl border-2 border-blue-500/20 group-hover:border-blue-500/40 transition-all duration-500 group-hover:shadow-[0_0_50px_rgba(59,130,246,0.3)] hover-tilt hover-lift">
                <div className="aspect-[4/3] bg-gradient-to-br from-blue-500/10 via-cyan-500/10 to-purple-500/10 rounded-2xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="text-center relative z-10">
                    <BarChart3 className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 text-blue-500 mx-auto mb-3 sm:mb-4 drop-shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500" />
                    <p className="text-muted-foreground font-medium group-hover:text-foreground transition-colors duration-300" style={{ fontSize: 'clamp(0.8125rem, 1vw + 0.25rem, 1rem)' }}>
                      Analytics Dashboard
                    </p>
                  </div>
                </div>
