...
-- Create resume_analytics table for tracking views and shares
...
-- Create saved_resumes table for users to save others' public resumes
...
create index resumes_slug_idx on public.resumes(slug);
create index resumes_is_public_idx on public.resumes(is_public) where is_public = true;
...
insert into public.templates (id, name, description, category, has_photo, layout_type) values
  ('classic', 'Classic', 'Traditional single-column layout', 'professional', false, 'single-column'),
  ('executive', 'Executive', 'Professional with photo header', 'professional', true, 'photo-header'),
  ('creative', 'Creative', 'Sidebar with photo and skills', 'creative', true, 'sidebar'),
  ('minimal', 'Minimal', 'Clean and spacious layout', 'general', false, 'minimal'),
  ('corporate', 'Corporate', 'Formal business layout with photo', 'professional', true, 'corporate');

-- Insert default themes
insert into public.themes (id, name, colors, fonts) values
  ('black', 'Black', '{"primary": "#000000", "secondary": "#374151", "accent": "#3B82F6"}', '{"heading": "Inter", "body": "Inter"}'),
  ('dark-gray', 'Dark Gray', '{"primary": "#1F2937", "secondary": "#4B5563", "accent": "#3B82F6"}', '{"heading": "Inter", "body": "Inter"}'),
  ('navy-blue', 'Navy Blue', '{"primary": "#1E3A8A", "secondary": "#3B82F6", "accent": "#EF4444"}', '{"heading": "Inter", "body": "Inter"}'),
  ('professional', 'Professional', '{"primary": "#374151", "secondary": "#6B7280", "accent": "#059669"}', '{"heading": "Inter", "body": "Inter"}');
